...
public class PracticeTask8_StockMarket {
    public static void main(String[] args) {
        ...
        System.out.println("Enter your shares' total value in the stock market:");
        int totalValue = input.nextInt();

        input.nextLine();
        System.out.println("Enter the company name which you have the most shares:");
