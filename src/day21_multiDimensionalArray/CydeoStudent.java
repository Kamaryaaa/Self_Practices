...
public class CydeoStudent {
    public static void main(String[] args) {
        ...
        String [] [] batch2Groups = {batch1Group1,batch2Group2,batch2Group1};

        String[][][] cydeoStudents={batch1Groups,batch2Groups};


        for (String[][] eachBatchGroups : cydeoStudents) {
            for (String[] eachSmallGroups : eachBatchGroups) {
                for (String eachStudents : eachSmallGroups) {
